        ...
        <form:form method="post" modelAttribute="donation">
            ...
            <div data-step="3">
                ...
                <c:forEach var="institution" items="${institutionList}">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <form:radiobutton path="institution" items="${institutions}"/>
                ...
                <div class="summary">
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span id="showBags"></span>
                            </li>

                            <li>
                                <span class="icon icon-hand"></span>
                                <span class="summary--text"></span>
                                <span id="showInstitution"></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="form-section form-section--columns">
                        <div class="form-section--column">
                            <h4>Adres odbioru:</h4>
                            <ul>
                                <li><span id="showStreet"></span></li>
                                <li><span id="showCity"></span></li>
                                <li><span id="showZipCode"></span></li>
                                <li><span id="showPhoneNumber"></span></li>
                            </ul>
                        </div>
                        ...
                        <div class="form-section--column">
                            <h4>Termin odbioru:</h4>
                            <ul>
                                <li><span id="showPickUpDate"></span></li>
                                <li><span id="showPickUpTime"></span></li>
                                <li><span id="showComment"></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
